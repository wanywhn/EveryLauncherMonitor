...
#define PROCFS_NAME			"vfs_write_changes"
...
#define VC_IOCTL_ADDITEM	_IOR(VC_IOCTL_MAGIC, 3,long)
#define VC_IOCTL_DELETEITEM	_IOR(VC_IOCTL_MAGIC, 4, long)
...
typedef struct __vc_ioctl_item_args__{
    int size;
	char *data;
}ioctl_item_args;
